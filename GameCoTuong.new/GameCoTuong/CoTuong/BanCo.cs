...
namespace GameCoTuong.CoTuong
{
    public class BanCo
    {
        ...
        {
            BanCo.quanCoBiLoai = BanCo.danhSachQuanCo.Find(element => element.quanCo.Mau != BanCo.pheDuocDanh && element.quanCo.ToaDo == toaDo);
            if (BanCo.quanCoBiLoai != null)
            {
                ptbBanCo.Controls.Remove(BanCo.quanCoBiLoai);
                BanCo.danhSachQuanCo.Remove(BanCo.quanCoBiLoai);
                BanCo.alive.Remove(BanCo.quanCoBiLoai.quanCo);
            }
        }
