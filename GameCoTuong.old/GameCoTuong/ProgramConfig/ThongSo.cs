...
namespace GameCoTuong.ProgramConfig
{
    public static class ThongSo
    {
        ...
        - Gốc tọa độ trên bàn cờ của điểm bàn cờ và quân cờ KHÔNG trùng nhau, do đó TDBC của chúng cũng khác nhau. Nhưng chúng dùng chung TDDV.
        */
        ...
        private static int gocQuanCoX = 31; // hoành độ gốc của điểm bàn cờ trên bàn cờ (góc trên bên trái)
        public static int GocQuanCoX { get { return gocQuanCoX; } }

        private static int gocQuanCoY = 30; // tung độ gốc của điểm bàn cờ trên bàn cờ (góc trên bên trái)
        public static int GocQuanCoY { get { return gocQuanCoY; } }
        #endregion

        #region Khoảng cách
        private static int khoangCach = 61; // khoảng cách giữa các điểm bàn cờ
