...
namespace GameCoTuong.CoTuong
{
    ...
    {
        #region
        public static int mauPheTa = 2; // màu của phe ta (phe xuất phát ở nửa dưới bàn cờ)
        //public static NuocDi nuocDiTruocDo;
        ...
        public static void TaoQuanCo(EventHandler QuanCo_Click, PictureBox ptbBanCo)
        {
            ...
            foreach (RoundPictureBox element in danhSachQuanCo) // Gắn cho mỗi RoundPictureBox quân cờ 1 sự kiện click và xếp nó lên bàn cờ
            {
